<template>
  <div>
    <!-- Showing the User information (name, contact...) -->
    <el-card style="height: 35vh; margin: 0 auto; width: 98%">
          ...
          <template #dropdown>
            <el-dropdown-menu class="custom-dropdown-menu">
              <el-dropdown-item class="dropdownitem" @click="isDialogProfile = true"
                ><el-button class="mr-2" type="success" size="small" circle>
      ...
      <div style="display: flex">
        <!-- 2.1 - name, position, department, avatar, status, role  -->
        <div style="display: flex; width: 49%; border-right: 2px dashed #d3d3d4">
          <div class="relative">
            <el-avatar class="ml-3" :size="130" src="https://i.redd.it/8a0wds8pzwmb1.jpg" />
            <div style="position: absolute; bottom: 43px; right: 30px; z-index: 1">
              <el-tag
                v-if="userData.status"
                :color="userData.status.color"
                style="margin-right: 5px; border-radius: 50%; width: 15px; height: 15px; z-index: 1"
                size="small"
                height="15px"
              />
            </div>
            <div
              style="position: absolute; bottom: 20px; right: -5px; z-index: 1; text-align: left"
            >
              <el-tag
                v-if="userData.status"
                :style="{
        ...
        <!-- 2.2 - email, phone, userId, isActive -->
        <div style="width: 30%; margin-left: 30px">
          <ul>
            <li class="mb-5 text-sm">
              <div class="ml-5">
                <strong>Email:</strong
                ><span style="width: 300px; margin-left: 50px; color: #50c878">
    ...
    <!-- Showing Qualifications and Skills -->
    <div style="display: flex; justify-content: space-around; margin-top: 40px">
      ...
      <el-card style="width: 48%">
        ...
        >
          Qualifications:
          <!-- <el-icon size="25px" class="ml-5 mt-1" @click="isDialogQualification = true">
            <Edit />
          </el-icon> -->
        </h3>
        <div>
          <el-timeline>
            ...
            >
              <li style="margin-bottom: 0px">
                <el-tag type="primary" style="font-weight: bold; font-size: 15px">{{
                  qualification?.title
                }}</el-tag>
                ...
                <div class="list-qualification">
                  ...
                  <span>{{ new Date(qualification.dateObtained).getFullYear() }}</span>
                </div>
              </li>
            </el-timeline-item>
          </el-timeline>
      ...
      <!-- Skills -->
      <el-card style="width: 48%">
        <h3 style="font-size: 20px; margin-bottom: 10px">Skills:</h3>
        <div class="informationSkill flex-row items-center justify-start my-1">
          <el-row :gutter="10">
            <el-col v-for="skill in selectProfile.skills" :key="skill.title" :span="4">
              <el-card
                :style="{
    ...
    <el-dialog v-model="isDialogProfile" title="Edit Profile" width="800" draggable>
      <el-form :model="selectProfile">
        ...
        <!-- Dialog for Showing Qualification -->
        <el-form-item label="Education" :label-width="formLabelWidth">
          <div class="flex">
            <div style="flex: 1; overflow-x: hidden">
              ...
              >
                <el-row
                  v-for="qualification in selectProfile.qualifications"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                      <span
                        style="font-size: 18px; font-weight: bold; color: #333; margin: 0 2px"
                    ...
                    >
                      <span
                        style="
                          ...
                          width: 100px;
                        "
                        >{{ new Date(qualification.dateObtained).getFullYear() }}</span
                      >
...
<script lang="js">
  ...
  import { VcardSevices } from '@/modules/vcard/services'
  ...
  export default {
    ...
    setup() {
      ...
      const getVcardApi = async () => {
        try {
          const response = await getVcardService.getVcardById(state.userData.idUser)
      ...
      const addQualification = async () => {
        ...
        state.typeQualification = "CREATE";
        state.isDialogProfile = false;
        state.isDialogQualification = true;
      };
      const saveQualification = async () => {
        try {
          ...
          if (state.typeQualification === "CREATE") {
