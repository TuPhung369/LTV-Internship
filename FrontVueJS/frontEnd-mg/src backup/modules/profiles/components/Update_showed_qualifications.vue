...
<script lang="js">
  ...
  import { ArrowLeft, Edit, Message, Phone, Switch, Lock, Brush, Calendar, List, Monitor, EditPen } from '@element-plus/icons-vue'
  ...
  export default {
    name: 'UserProfile',
    components: {
      ElRow,ElCol,ElCard, ElContainer, ElHeader, ElMain, ElAside, ElDivider, ElAvatar, ElButton, ElLink, ElMenu, ElMenuItem, ElIcon, ElDialog, ElForm, ElFormItem, ElInput, ArrowLeft, Edit, Message, Phone, Switch, Lock, Brush, Calendar, List, Monitor, EditPen,
    },
    setup() {
      ...
      onMounted(async () => {``
        try {
          ...
          //console.log('99999999999999qualificationsUser:', qualificationsUser.value)
        } catch (error) {
