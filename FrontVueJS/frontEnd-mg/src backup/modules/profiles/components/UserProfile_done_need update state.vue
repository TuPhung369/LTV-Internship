<template>
  <div class="flex items-center justify-center mt-0">
    <el-container class="w-full h-full max-w-7xl">
      ...
      <el-main class="flex flex-col w-4/5 bg-white">
        ...
        <div class="educationAccount ml-5 mr-5">
          ...
          <div class="informationEducation flex items-center justify-start my-1">
            <el-row :gutter="10">
              <el-col
                v-for="qualification in qualificationsOptions"
              ...
              >
                ...
                >
                  <div>
                    {{ qualification.label }} - {{ qualification.field }} -
    ...
    <!-- Model edit profile -->
    <el-dialog v-model="dialogFormVisible" title="Edit User Profile" width="700" draggable>
      ...
      <el-form-item label="Your Education" :label-width="formLabelWidth">
        ...
        >
            ...
            >
              ...
              >
                ...
                <div style="display: flex; justify-content: space-between">
                  ...
                  >
                  <span
                    style="flex: 1; font-size: 18px; font-weight: bold; color: #777; margin: 0 2px"
                    >{{ qualification.year }}</span
                  >
                </div>
                <div style="display: flex; justify-content: space-around; margin-top: 10px">
                  <el-button @click="editQualification(qualification.value)"
                    ><el-icon :size="30"> <Edit /> </el-icon
                  ></el-button>

                  <el-button @click="deleteQualification(qualification.value)"
          ...
          <div style="margin-top: 1px">
            <el-button @click="addQualification">
  ...
  export default {
    ...
    setup() {
      ...
      const editQualification = (qualificationId) => {
        const qualification = qualificationsData.value.find(q => q.id === qualificationId);
        if (qualification) {
      ...
      const deleteQualification = async (qualificationId) => {
        try {
          ...
          qualificationsData.value = qualificationsData.value.filter(qualification => qualification.id !== qualificationId);
      ...
      const updateProfile = async () => {
        try {
          ...
          //profile.qualificationIds = qualificationsData.value.map(qualification => qualification.id); //*BUG*
          // console.log('11111111111111profile:', profile)
          // console.log('11111111111111skillsUser:', skillsUser.value)
          // console.log('222222222222qualificationsData:', qualificationsData.value)
      ...
      const qualificationsOptions = computed(() => {
          //console.log('1111111111111qualificationsData:', qualificationsData.value)
        if (!qualificationsData.value || !Array.isArray(qualificationsData.value)) {
          return [];
        }
        return qualificationsData.value.map(qualification => ({
      ...
      //console.log('222222222222222qualificationsOptions:', qualificationsOptions.value)
      ...
      onMounted(async () => {``
        try {
          ...
          qualificationsData.value = await userProfile.actGetQualifications()//get all qualifications
          //console.log('skillsData:', skillsData.value)
          //console.log('qualificationsData:', qualificationsData.value)
